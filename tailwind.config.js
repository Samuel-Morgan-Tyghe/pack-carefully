...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "wood-pattern":
          'url("https://images.unsplash.com/photo-1621360841013-c768371e93cf?q=80&w=2574&auto=format&fit=crop")',
        "leather-texture":
          'url("https://www.transparenttextures.com/patterns/leather.png"), linear-gradient(135deg, #5D4037 0%, #3E2723 100%)',
        "paper-texture":
      ...
      boxShadow: {
        ...
        "leather-stitch":
          "inset 0 0 20px rgba(0,0,0,0.8), 0 10px 20px rgba(0,0,0,0.5), 0 0 0 4px #3E2723, 0 0 0 6px #8D6E63",
