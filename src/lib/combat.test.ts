...
async function runTests() {
    ...
    // TEST 1: Basic Attack
    {
        ...
        if (result2.playerCooldowns[0].current === 1000) console.log('✅ Cooldown reset');
        else console.error(`❌ Cooldown did not reset, is ${result2.playerCooldowns[0].current}`);
    }
    ...
    // TEST 2: Shield Absorb
    {
        ...
        if (result.enemy.shield < 10) console.log(`✅ Shield reduced: ${result.enemy.shield}`);
