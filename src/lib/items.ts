    ...
    synergies: [
      {
        ...
        targetIsSelf: true,
        apply: (_, target) => {
          if (ITEMS[target.itemId].category === "ESSENTIAL")
            return { buffs: { maxEnergy: 10 } }
          return {}
        },
      },
    ],
    ...
    synergies: [
      {
        ...
        apply: (_, target) => {
          ...
          if (
            targetDef.category === "ESSENTIAL" &&
            (target.itemId === "rations" || target.itemId === "water_bottle")
          ) {
    ...
    synergies: [
      {
        ...
        targetIsSelf: true,
        apply: (_, target) => {
          if (target.itemId === "water_bottle")
            return { multipliers: { heal: 1.5 } }
          return {}
        },
      },
    ],
    ...
    synergies: [
      {
        ...
        apply: (_, target) => {
          const targetDef = ITEMS[target.itemId]
          if (
            targetDef.category === "CLOTHING" ||
            targetDef.category === "SURVIVAL" ||
            target.itemId === "wooden_shield"
          ) {
