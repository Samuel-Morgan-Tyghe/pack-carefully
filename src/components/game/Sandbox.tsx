...
import { clearSandboxGrid, SANDBOX_PLAYER_ID, leaveSandbox } from '../../store/gameStore';
...
const CATEGORIES = ['WEAPON', 'TOOL', 'ESSENTIAL', 'SURVIVAL', 'COMFORT', 'CONTAINER', 'SABOTAGE', 'CLOTHING'];
        ...
        <div className="w-full h-full flex flex-col md:flex-row gap-4 p-4 overflow-hidden">
            ...
            <section className="flex-1 flex flex-col items-center justify-center relative overflow-hidden">
                <div className="mb-4 text-center">
                    <h1 className="text-2xl font-black text-white uppercase tracking-tighter mb-1">Synergy Sandbox</h1>
                    <p className="text-wood-400 text-sm italic">Place items to test adjacency rules and synergies.</p>
                </div>
                ...
                <div className="mt-8 flex gap-4">
                    <div className="flex items-center gap-2 text-xs text-wood-400 bg-black/40 px-4 py-2 rounded-full border border-white/5">
                        <kbd className="px-1.5 py-0.5 bg-wood-700 rounded text-parchment-100 font-mono">R</kbd> Rotate
                    </div>
                    <div className="flex items-center gap-2 text-xs text-wood-400 bg-black/40 px-4 py-2 rounded-full border border-white/5">
                        <kbd className="px-1.5 py-0.5 bg-wood-700 rounded text-parchment-100 font-mono">DEL</kbd> Remove
                    </div>
                </div>
            </section>
        </div>
