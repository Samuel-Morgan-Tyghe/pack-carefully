...
const SplitScreen: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-50 bg-black/90 flex flex-col items-center justify-center text-parchment-100 p-8">
      <h2 className="text-4xl font-black mb-8 text-center tracking-widest uppercase">
      ...
      <div className="flex gap-8 w-full max-w-7xl justify-center h-[60vh]">
        ...
        <div
          className={clsx(
            ...
            leftStatus === "RESOLVED"
              ? "border-green-600 bg-green-900/20 opacity-50"
        ...
        >
          ...
          <div className="flex-1 w-full bg-black/30 rounded-lg p-4 mb-4 relative z-10 overflow-y-auto">
            ...
            {leftPlayers.length === 0 && (
              <div className="text-parchment-500 italic text-center mt-8">
                No one assigned
              </div>
            )}
          </div>
        ...
        <div className="w-64 flex flex-col items-center justify-center gap-4">
          <div className="text-parchment-400 font-bold uppercase tracking-widest text-sm mb-2">
            Unassigned Team
          </div>
        ...
        >
          ...
          <h3 className="text-3xl font-bold mb-2 relative z-10 text-red-400">
            THE DARK WOODS
          </h3>
          <p className="text-lg text-parchment-300 text-center relative z-10 mb-4">
      ...
      <div className="mt-8 text-parchment-400 text-sm">
        * Assign everyone before departing. Unassigned players wait at camp
        (Skip turn).
      </div>
    </div>
  )
