...
import { $gameState, returnToSplitScreen } from "../../store/gameStore"
...
const JourneyResults: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-parchment-100 p-8 h-full">
      <h2
        className={`text-5xl font-black mb-4 tracking-wider ${isVictory ? "text-green-500" : "text-red-500"}`}
      >
      ...
      <div className="bg-black/30 p-6 rounded-lg border border-wood-600 mb-12 max-w-md text-center">
        {isVictory ? (
          <p className="text-green-300 text-lg">
            You successfully repelled the threat. The team's morale remains
            high.
          </p>
        ) : (
          <div className="space-y-2">
            <p className="text-red-400 text-lg font-bold">-20 Morale</p>
