...
import { $gameState, completeScavenge, addRandomLoot, $activePreview } from '../../store/gameStore';
        ...
        <div className="flex flex-col items-center justify-center h-full p-8 text-white">
            <div className="max-w-2xl w-full bg-slate-900/90 border-2 border-slate-700 rounded-xl p-8 shadow-2xl">
                <div className="flex items-center gap-4 mb-6 border-b border-slate-700 pb-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-black text-indigo-300 uppercase tracking-widest">{event.title}</h2>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        {lootPool.map((item, idx) => {
                            ...
                            return (
                                ...
                                >
                                    <Icon size={32} className="text-slate-300 group-hover:text-white" />
