  ...
  return (
    <div className="pt-6 border-t font-serif border-wood-700 text-parchment-500">
      ...
      >
        <div
          className={clsx(
            "w-10 h-10 rounded-full border-2 flex items-center justify-center font-bold text-parchment-100 font-display text-lg shadow-md",
            player.avatarColor,
          )}
        >
          {player.name[0]}
        ...
        <div>
          ...
          <div className="text-xs text-wood-400 flex items-center gap-1 font-bold">
            <LucideIcons.Shield
              size={10}
              className={isMe ? "text-gold-500" : "text-wood-500"}
            />
            {player.role}
          </div>
        </div>
