        ...
        <div className="max-w-md mx-auto bg-wood-800/50 p-8 rounded-2xl border-2 border-wood-700 backdrop-blur-sm shadow-2xl">
          {currentPlayer ? (
            <div className="text-center animate-in zoom-in duration-500">
              <h2 className="text-xl font-display text-parchment-100 mb-2 tracking-widest uppercase">
                Welcome Back
              </h2>
              <div className="flex items-center justify-center gap-3 mb-6">
                <div
                  className={`w-3 h-3 rounded-full ${currentPlayer.avatarColor} shadow-[0_0_10px_rgba(0,0,0,0.5)]`}
                />
                <span className="text-3xl font-black text-gold-500 italic drop-shadow-md">
                  {currentPlayer.name}
                </span>
              </div>
              <p className="text-wood-400 text-sm mb-4 italic">
            ...
            <>
              <h2 className="text-xl font-display text-parchment-100 mb-6 tracking-widest uppercase">
        ...
        {players.length > 0 && (
          <div className="mt-12 flex flex-col items-center gap-6">
            <div className="text-wood-400 font-bold uppercase tracking-widest text-sm bg-wood-900/50 px-6 py-2 rounded-full border border-wood-700">
              {players.length}{" "}
              {players.length === 1 ? "Adventurer" : "Adventurers"} Joined
            </div>
